				...
				<div class="navbar-collapse collapse">
			 	 ...
			 	 <li class="nav-item dropdown">
						...
						<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown"> 
							...
							<?php
							if (isset($_SESSION["nguoidung"]) && is_array($_SESSION["nguoidung"]) && isset($_SESSION["nguoidung"]["hoten"])) {
								echo "Chào " . $_SESSION["nguoidung"]["hoten"];
							} else {
								echo "Chào bạn";
							}
							?>
						...
						<div class="dropdown-menu dropdown-menu-end">
							<a class="dropdown-item" href="../ktnguoidung/index.php?action=hoso"><i class="align-middle me-1" data-feather="user"></i> 
							Hồ sơ cá nhân
							</a>
							<a class="dropdown-item" href="../ktnguoidung/index.php?action=matkhau"><i class="align-middle me-1" data-feather="key"></i> 
							Đổi mật khẩu
							</a>
