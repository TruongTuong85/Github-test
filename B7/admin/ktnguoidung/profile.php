            ...
            <div class="card-header">
                <h4 class="text-info text-center">HỒ SƠ NGƯỜI DÙNG</h4>
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="txtid" value="<?php echo $_SESSION["nguoidung"]["id"]; ?>" > <input type="hidden" name="txthinhanh" value="<?php echo $_SESSION["nguoidung"]["hinhanh"]; ?>"> <input type="hidden" name="action" value="xlhoso">
                        <div class="text-center">

                    <img class="img-thumbnail" src="<?php echo empty($_SESSION["nguoidung"]["hinhanh"]) 
                    ? '../../images/users/user.png' 
                    : '../../images/users/' . $_SESSION["nguoidung"]["hinhanh"]; ?>" 
                      ?>
                       </div>
                     <div class="my-3">
                     ...
                     <label class="form-label">Đổi hình đại diện</label>
                       ...
                       <div class="my-3 text-center">
                         <input class="btn btn-primary" type="submit" value="Cập nhật"> <input class="btn btn-warning" type="reset" value="Không">
                  </div> </form>
            </div>
        </div>
    </div>
